...
// Screen: Game Options - Production Ready
// 
// AGENT INSTRUCTIONS:
...
export type GameOptionsProductionReadyActionId = "button-1-1" | "button-2-2" | "button-3-3" | "reset-defaults-4" | "save-changes-5";

export interface GameOptionsProductionReadyProps {
  actions?: Partial<Record<GameOptionsProductionReadyActionId, () => void>>;
}

export function GameOptionsProductionReady({ actions }: GameOptionsProductionReadyProps) {
  return (
    <>
      {/* TopAppBar */}
      ...
      <label className="font-label-mono text-label-mono text-[#F8FAFC]">MASTER VOLUME</label>
      ...
      <div className="flex flex-col gap-sm">
      <div className="flex justify-between items-center">
      <label className="font-label-mono text-label-mono text-[#F8FAFC]">SFX VOLUME</label>
      ...
      <div className="flex flex-col gap-sm">
      <div className="flex justify-between items-center">
      <label className="font-label-mono text-label-mono text-[#F8FAFC]">MUSIC VOLUME</label>
      ...
      <div>
      <h4 className="font-label-mono text-label-mono text-[#F8FAFC]">GHOST PIECE</h4>
      ...
      <div className="flex justify-between items-center bg-surface-variant p-md rounded border border-outline-variant">
      <div>
      <h4 className="font-label-mono text-label-mono text-[#F8FAFC]">HARD DROP SHAKE</h4>
      ...
      <div className="flex justify-between items-center">
      <label className="font-label-mono text-label-mono text-[#F8FAFC]">STARTING DIFFICULTY (SPEED)</label>
      ...
      <button className="h-touch-target px-xl border border-outline-variant text-[#F8FAFC] font-label-mono text-label-mono hover:bg-surface-variant transition-colors rounded" type="button" data-action-id="reset-defaults-4" onClick={actions?.["reset-defaults-4"]}>
                                  RESET DEFAULTS
                              </button>
      <button className="h-touch-target px-xl border border-primary bg-primary/10 text-primary font-label-mono text-label-mono hover:bg-primary hover:text-[#141218] transition-colors rounded shadow-[0_0_10px_rgba(207,188,255,0.2)]" type="button" data-action-id="save-changes-5" onClick={actions?.["save-changes-5"]}>
                                  SAVE CHANGES
                              </button>
      </div>
      </div>
