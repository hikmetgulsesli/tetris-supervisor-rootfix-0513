...
export type PauseOverlayActionId = "resume-1" | "restart-2" | "settings-3" | "main-menu-4";
...
export function PauseOverlay({ actions }: PauseOverlayProps) {
  return (
    <>
      ...
      {/* Restart Button */}
      <button className="w-full h-touch-target flex items-center justify-center bg-surface border border-outline-variant text-on-surface hover:bg-surface-variant hover:border-outline transition-colors duration-200 rounded focus:outline-none focus:border-primary" type="button" data-action-id="restart-2" onClick={actions?.["restart-2"]}>
      ...
      {/* Settings Button */}
      <button className="w-full h-touch-target flex items-center justify-center bg-surface border border-outline-variant text-on-surface hover:bg-surface-variant hover:border-outline transition-colors duration-200 rounded focus:outline-none focus:border-primary" type="button" data-action-id="settings-3" onClick={actions?.["settings-3"]}>
