...
export type GameOverActionId = "reboot-sequence-1" | "main-menu-2" | "share-data-3";
...
export function GameOver({ actions }: GameOverProps) {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-error-container/20 via-background to-background z-0"></div>
      {/* Main Game Over Card */}
