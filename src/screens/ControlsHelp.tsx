...
export type ControlsHelpActionId = "button-1-1" | "button-2-2" | "button-3-3" | "return-to-menu-4";
...
export function ControlsHelp({ actions }: ControlsHelpProps) {
  return (
    <>
      ...
      <button className="self-start flex items-center gap-sm px-md py-sm border border-outline-variant rounded-DEFAULT bg-surface-container-low hover:bg-surface-variant hover:border-outline text-primary font-label-mono text-label-mono transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent active:scale-95 group" type="button" data-action-id="return-to-menu-4" onClick={actions?.["return-to-menu-4"]}>
      ...
      <h3 className="font-headline-panel text-headline-panel text-on-surface">CLEAR LINES</h3>
      ...
      <div className="flex flex-col gap-xs pt-xs">
      <h3 className="font-headline-panel text-headline-panel text-on-surface">VELOCITY ESCALATION</h3>
      ...
      <div className="flex flex-col gap-xs pt-xs">
      <h3 className="font-headline-panel text-headline-panel text-on-surface">MATRIX OVERFLOW</h3>
